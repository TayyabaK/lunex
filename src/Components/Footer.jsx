  ...
  return (
    ...
    >
      <div className="max-w-7xl flex ml-[92px]">
        <div className="flex flex-col items-start">
          <div className="flex flex-row pl-10 pb-[18px]">
            <img
              ...
              className="mb-4 w-32"
            />
            <span className="text-[60px] text-white font-bold pl-8 pt-4">
              LUNEX
            </span>
          </div>
        ...
        <div className="absolute flex flex-row ml-[710px] mt-[205px]">
      ...
      <div className="max-w-7xl flex flex-row text-gray-500 text-sm">
        <p className="flex-1 mb-4 md:mb-0 mt-8 max-w-[650px] ml-36">
        ...
        <div className="flex flex-row">
          ...
          <a href="#" className="hover:text-white mt-8 mb-4 md:mb-0 ml-44">
            Terms & Conditions
          </a>
        </div>
      </div>
