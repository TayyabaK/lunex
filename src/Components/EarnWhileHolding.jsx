...
const EarnWhileHolding = () => {
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(circle 50vh at 10% 5%, #273b1d, transparent) black",
      }}
    >
      <div
      ...
      >
        <div className="text-white p-8 px-56 flex flex-col items-start space-y-8">
          <h1 className="leading-tight font-bold w-[350px] text-white [font-family:'Archivo-Bold',Helvetica] lg:text-[60px] xl:text-[60px] text-[60px]">
            Earn While Holding.
          </h1>
